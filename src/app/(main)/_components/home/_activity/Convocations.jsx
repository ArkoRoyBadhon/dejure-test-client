...
export const ConvocationsComponent = ({ ok }) => {
  const {
    data: galleries,
    isLoading,
    error,
  ...
  // Use the sixth gallery data if available (index 5)
  const gallery = galleries && galleries.length > 5 ? galleries[5] : null;
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="h-[650px] w-[588px] flex flex-col justify-between gap-6">
            ...
            <div className="h-[200px] w-full flex flex-col">
              <div className="h-[calc(200px-40px)] w-full">
                <Image
                  src={`${process.env.NEXT_PPUBLIC_API_URL}/${
      ...
      {/* Edit Form Section */}
      {ok && (
        <div className="bg-white rounded-2xl shadow-[0px_8px_40px_rg0,0,0,0.1)] p-6">
