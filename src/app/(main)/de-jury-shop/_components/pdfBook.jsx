...
export default function PdfBooks() {
  ...
  const printedBooks =
    Products?.filter(
      (product) => product.category?.title?.trim() === "PDF বই"
    ) || [];
  ...
  return (
    <div className="relative   max-w-[100vw] w-full overflow-hidden mx-auto  px-4 md:px-0">
      {/* Background image */}
      ...
      <div className="flex flex-col relative z-[1] max-w-[1200px] mx-auto min-h-[40vh] pb-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <p className="font-black text-2xl md:text-3xl">PDF বই</p>
          </div>
          <div className="flex items-center gap-2">
        ...
        >
          {isLoading ? (
            ...
            printedBooks.map((product) => (
              <div key={product._id} className=" bg-white rounded-xl  ">
                ...
                <div className=" mt-2 flex-1 flex flex-col justify-between h-30">
                  <div className="flex flex-col justify-center items-center gap-2 text-sm h-2/3 mb-2">
                    <p className="font-semibold text-lg text-gray-800 text-center  overflow-hidden text-ellipsis">
