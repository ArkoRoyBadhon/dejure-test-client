    ...
    <AuthChecker requiredRole="mentor">
      <div className="h-[calc(100vh)]  overflow-hidden bg-gray-50">
        ...
        <div className="flex max-w-[1556px] mx-auto">
          ...
          <main className="flex-1 mt-2 md:px-4 lg:px-0 max-h-[calc(100vh-90px)] overflow-y-auto no-scrollbar">
