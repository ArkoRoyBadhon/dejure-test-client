      ...
      <div className="mx-auto space-y-4">
          ...
          <div className="hover:shadow-lg bg-main/5 border border-main transition-shadow flex p-3 gap-4 rounded-lg">
            ...
            <div className="bg-gray-100 rounded-lg flex items-center justify-center w-28 h-28">
              ...
              <Image
                src={
                  examData?.thumbnail
                    ? `${process.env.NEXT_PUBLIC_API_URL}/${examData.thumbnail}`
                    : "/assets/fallImg.jpg"
                }
                width={100}
                height={100}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div
              className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm hover:shadow-md cursor-pointer transition-shadow"
              onClick={() =>
            ...
            <div
              className="flex items-center justify-between p-4 py-4 bg-white rounded-lg shadow-sm hover:shadow-md cursor-pointer transition-shadow"
              onClick={() =>
